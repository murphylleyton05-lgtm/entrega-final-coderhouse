...
## 3. Fondos con video real (opcional)

1. Sacá una API key gratis en https://www.pexels.com/api/
2. Ponela en `.env` como `PEXELS_API_KEY=`
3. En `config.yaml`, cambiá `fondo.tipo` de `gradiente` a `pexels`.
